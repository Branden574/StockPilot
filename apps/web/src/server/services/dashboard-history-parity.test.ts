...
/**
 * PARITY SUITE for migration 0224.
 *
 ...
 *     of what the SQL RPCs emit (per-day rows), mirroring the migration's
 ...
 * verified by supabase/tests/0224_dashboard_history_series.test.sql.
 *
...
describe('dashboard_history_series parity (RPC vs pre-0224 reverse-walk)', () => {
  const cases: Array<{ name: string; rangeDays: number; items: ItemFix[]; movs: MovFix[] }> = [
    {
