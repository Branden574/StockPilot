...
export default async function InventoryPage({
  ...
  // a separate sequential await put one full DB round trip between the
  // skeleton and the real toolbar — and therefore in front of the table
  // — on EVERY hard load (cold-start plan rank 2). withContext is
