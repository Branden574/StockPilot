...
const GOLDEN_DELTA_QUERIES = [
  ...
  'inventory_items | id, quantity_on_hand, warehouse_id | select("id, quantity_on_hand, warehouse_id") in("id",["ph-1"]) is("deleted_at",null) order("id",{"ascending":true}) range(0,999)',
