/**
 * Optional bottom-tab route for Rentals (Settings → Customize tab bar).
 *
 * Named rentals-tab (path /rentals-tab) — NOT rentals — deliberately: the
 * drawer already owns /rentals (app/(drawer)/rentals.tsx), and a same-path
 ...
 * cycle-counts tab.
 */
export { default } from '@/screens/rentals';
